package br.com.taugs.jobinsights.infra.error;
...
public class TratadorDeErros {
	...
	public ResponseEntity<String> tratarErroEmailDuplicado() {
		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("O email ja esta sendo utilizado por outro usuario");
	}
